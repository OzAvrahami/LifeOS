...
| --- | --- |
| Foundation + Today states | docs/VISION.md, docs/PRODUCT_SPEC_V0.1.md, docs/TODAY_SCREEN_SPEC.md, docs/CORE_FLOW.md, docs/wireframes/TODAY.md |
