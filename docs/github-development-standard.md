...
Git state-changing operations require owner authorization; the owner explicitly authorized the 0.3.0 acceptance documentation commit/push. GitHub publication remains owner-controlled. LifeOS 0.3.0 (4) is owner-accepted for #3/#4, both Closed/Completed/Done, and v0.3.0 is now published and Latest (2026-09-13T19:24:14Z, non-draft/non-prerelease). Its annotated tag intentionally targets acceptance checkpoint `cefd84a6d8e21c631bc666d49d20ac91ccce2657`. Post-publication documentation commits must not move or recreate that tag; no v0.3.0 publication action remains. See [the current acceptance record](release-0.3.0-verification.md). The historical v0.2.1 publication settings remain in [its record](release-0.2.1-verification.md#owner-publication-settings-and-stop-point).
