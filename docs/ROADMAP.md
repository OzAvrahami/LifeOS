...
- **v0.3.0** — published 2026-09-13 at 19:24:14 UTC, Latest at publication (superseded by v0.4.0), non-draft and non-prerelease. Internal 0.3.0 (4) is owner-accepted for #3 Weekly Planning lifecycle and #4 Week/day navigation; tag target `cefd84a6d8e21c631bc666d49d20ac91ccce2657`. Not App Store/TestFlight.
- **v0.4.0** — internal **0.4.0 (7)** owner-accepted for release on **2026-09-22**: Notifications MVP (#1), including Task access, relative Commitment reminders, Weekly reminders and Xcode 27 scene support. Production schema/API rollout complete. Published **2026-09-22T11:04:34Z**, **Latest**, non-draft and non-prerelease; final annotated tag target `ce7e66fb620f046b60fcd2bbe468fad09ac5c96b`. #26 explicit category toggles and #27 contextual settings are non-blocking future UX follow-ups (Backlog / P2). See [release evidence and its limits](release-0.4.0-verification.md).
- **v1.0.0** — a later stable-product milestone; it is not the current target.

Published GitHub Releases are authoritative for released versions, as defined in `github-development-standard.md`. [LifeOS v0.4.0 — Notifications](https://github.com/OzAvrahami/LifeOS/releases/tag/v0.4.0) is **published and Latest**, non-draft and non-prerelease, published **2026-09-22T11:04:34Z**. The final annotated tag resolves to `ce7e66fb620f046b60fcd2bbe468fad09ac5c96b` and must not be moved or recreated. Accepted internal binary remains **0.4.0 (7)**. Acceptance/publication are complete; post-publication documentation does not change the tag. See [the release record](release-0.4.0-verification.md).
...
**Publication milestone: COMPLETE.** [LifeOS v0.3.0 — Weekly planning and week navigation](https://github.com/OzAvrahami/LifeOS/releases/tag/v0.3.0) was published on 2026-09-13 at 19:24:14 UTC as Latest, non-draft and non-prerelease (superseded by v0.4.0 on 2026-09-22), with fixed annotated tag target `cefd84a6d8e21c631bc666d49d20ac91ccce2657`. No further v0.3.0 action remains.

**0.4.0 milestone: OWNER-ACCEPTED AND PUBLISHED.** On 2026-09-22 the owner accepted build 7 after installation/launch and usable visible UI, stating it appears to work correctly and approving release. #1 is Closed / Completed / Done. This does not certify every individual physical notification scenario; prior automated evidence remains separate. #26/#27 are non-blocking Backlog follow-ups. v0.4.0 is now Latest, published 2026-09-22T11:04:34Z, non-draft and non-prerelease; its final tag remains at `ce7e66fb620f046b60fcd2bbe468fad09ac5c96b`.

**Completed follow-up — 2026-09-23:** #9's approved optional normal/important decision and Git checkpoint are complete (Closed / Completed / Done / P2). #2 Task/Weekly Focus clarification is Closed / Completed / Done / P1 after scoped owner acceptance of wirelessly installed **0.4.1 (8)**: “נראה טוב” (“Looks good”), following the supplied checklist. This does not attest each scenario individually. [0.4.1 release documentation](release-0.4.1-verification.md) is prepared; publication has not occurred and Latest remains v0.4.0. The final tag must follow approval and commit of final documentation. #5 and other backlog scope remain separate; no new implementation is selected.
