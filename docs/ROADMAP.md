...
- **v0.4.0** — internal **0.4.0 (7)** owner-accepted for release on **2026-09-22**: Notifications MVP (#1), including Task access, relative Commitment reminders, Weekly reminders and Xcode 27 scene support. Production schema/API rollout complete. Publication **prepared / not yet published**; Latest remains v0.3.0. #26 explicit category toggles and #27 contextual settings are non-blocking future UX follow-ups (Backlog / P2). See [release evidence and its limits](release-0.4.0-verification.md).
...
**0.4.0 internal milestone: OWNER-ACCEPTED; PUBLICATION PREPARED.** On 2026-09-22 the owner accepted build 7 after installation/launch and usable visible UI, stating it appears to work correctly and approving release. #1 is Closed / Completed / Done. This does not certify every individual physical notification scenario; prior automated evidence remains separate. #26/#27 are non-blocking Backlog follow-ups. Latest published remains v0.3.0.
