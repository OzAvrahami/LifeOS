...
**Selected follow-up — 2026-09-23:** #9 optional normal/important semantics are owner-approved; it remains Open / Verify / P2 pending the owner Git checkpoint. #2 is Open / Verify / P1 after software verification of Task/Weekly Focus source labels and explicit independent Task capture; see [its software/acceptance handoff](issue-2-verification.md). The combined [0.4.1 (8) patch candidate](release-0.4.1-verification.md) is locally prepared, not built/installed/accepted/published; #2 physical acceptance remains pending. Broader Daily Planning (#5), Google Calendar integration and other backlog scope remain separate. The [canonical workflow](DEVELOPMENT_WORKFLOW.md) keeps accepted internal builds distinct from publication. See [the acceptance record](release-0.3.0-verification.md).
